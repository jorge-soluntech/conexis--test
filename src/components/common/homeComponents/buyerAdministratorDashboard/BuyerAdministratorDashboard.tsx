...
import useQuantityItemsDashboard from '@/components/common/homeComponents/useQuantityItemsDashboard';
...
import styles from './buyerAdministratorDashboard.module.scss';

const { Content } = Layout;

const BuyerAdministratorDashboard = () => {
  ...
  const memoizedCards = useMemo(() => {
    return homeUI.ITEMS_DETAILS_ADMIN.map((item: any, index: number) => {
      const quantity = quantityMap[item.key] || 0;
...
export default BuyerAdministratorDashboard;
