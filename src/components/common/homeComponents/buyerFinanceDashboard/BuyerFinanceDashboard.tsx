...
import styles from './buyerFinanceDashboard.module.scss';

const { Content } = Layout;

const BuyerFinanceDashboard = () => {
  ...
  const memoizedCards = useMemo(() => {
    return homeUI.ITEMS_DETAILS_BUYER_FINANCE.map(
...
export default BuyerFinanceDashboard;
