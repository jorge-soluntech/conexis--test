...
import styles from './programManagerDashboard.module.scss';
          ...
          {showMetrics && (
            <>
              ...
              <Row gutter={[20, 20]} align="top">
                <Col xs={24} sm={24} md={12} lg={8} className={styles.col}>
                  <CardMetrics
                  ...
                  {width >= 767 && width <= TABLET_BREAKPOINT ? (
                    <div style={{ marginTop: 20 }}>
                      <CardMetrics
                ...
                <Col xs={24} sm={24} md={0} lg={8} className={styles.col}>
                  <CardMetrics
                    title="Total open jobs"
                    value={'293'}
                    onClick={handleCardItemClick}
