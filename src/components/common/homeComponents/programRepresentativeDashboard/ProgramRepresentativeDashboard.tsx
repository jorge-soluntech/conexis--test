...
import styles from './programRepresentativeDashboard.module.scss';

const { Content } = Layout;

const ProgramRepresentativeDashboard = () => {
  ...
  const memoizedCards = useMemo(() => {
    return homeUI.ITEMS_DETAILS_PROGRAM_REPRESENTATIVE.map(
...
export default ProgramRepresentativeDashboard;
